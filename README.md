...
Start with no project folder and no connected accounts. The setup skill asks what the project is for, helps create or select a local folder, and walks through each needed connection one step at a time. The included builder preserves originals, creates full Markdown clones, reads the material, and organizes linked topic clusters and source indexes.
...
> Read START_HERE.md in this bundle and guide me through setup from the beginning. Ask what my second brain is for and whether I have a local project folder. Help me connect each needed tool one step at a time before building the second brain.
...
| Skill | Purpose |
| --- | --- |
| [setup-codex-workspace](skills/setup-codex-workspace/SKILL.md) | Guided project, folder, connector, memory and automation setup |
